# 🤝 Contributing to Claude Code Hub

First off, thank you for considering contributing to Claude Code Hub! It's people like you that make this resource valuable for the entire Claude Code community.
...
1. **Fork the Repository**
   ```bash
   git clone https://github.com/yourusername/claude-code-hub.git
   cd claude-code-hub
   ```
...
- 💭 [GitHub Discussions](https://github.com/yourusername/claude-code-hub/discussions) - Ask questions
- 💬 [Discord Server](https://discord.gg/claude-code) - Real-time chat
- 🐦 [Twitter](https://twitter.com/claude_code_hub) - Updates and news
